...
const AssistantSetting = () => {
  ...
  return selectedAssistant && (
    <div className='p-3 dark:bg-gray-900 bg-zinc-200 h-screen w-full relative'>
      ...
      <div className='fixed bottom-3 left-3 right-3 flex gap-2 md:gap-15 lg:gap-5 items-center justify-end px-2 md:px-3 py-2 z-20 max-sm:justify-around  lg:left-auto lg:right-3 lg:w-[calc(20%-0.75rem)] md:left-4 md:right-4'>
        <ConfirmationAlert onDelete={onDelete} disabled={loader} className='flex items-center justify-center w-10 h-10 text-white rounded-lg cursor-pointer transition-colors flex-shrink-0'>
