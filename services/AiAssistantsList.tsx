export default [
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "🥗 Can you suggest a vegan dinner recipe?",
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "🏝️ What are some budget-friendly beach destinations?",
            "🎒 What should I pack for a trip to the mountains?",
            "🍣 Suggest some must-try local food in Tokyo."
        ]
    },
    {
        id: 13,
        ...
        sampleQuestions: [
            ...
            "😥 How can I deal with work-related stress?",
            "☀️ Suggest a positive affirmation for the morning.",
            "📝 What is a good journaling prompt for anxiety?"
        ]
    },
    {
        id: 14,
        ...
        sampleQuestions: [
            ...
            "🏰 Can you give me a plot for a fantasy novel?",
            "🕵️ Describe a detective character for my story.",
...

    {
        ...
        sampleQuestions: [
            ...
            "📝 Give me some tips for learning German.",
            "🗣️ Can we have a simple conversation in Italian?"
        ]
    },
    {
        id: 16,
        ...
        sampleQuestions: [
            ...
            "🎸 Can you help me with a verse for a rock song?",
            "😢 Suggest some sad lyrics about a breakup.",
            "🎤 Give me an idea for a pop song."
        ]
    },
    {
        id: 17,
        ...
        sampleQuestions: [
            ...
            "✍️ Can you write a summary for my resume?",
            "✉️ Help me write a cover letter for a marketing position.",
            "🎯 What are some powerful action verbs to use?"
        ]
    },
    {
        id: 18,
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "🎨 Give me a creative idea for a painting.",
            "📈 What are some unique marketing ideas for a small business?",
            "✍️ I need a topic for my next blog post."
        ]
    },
    {
        id: 20,
        ...
        sampleQuestions: [
            ...
            "🌊 I dreamt I was in the ocean, what could that signify?",
            "🦁 Is there a meaning behind dreaming of a lion?",
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "🍿 Are there any new movie trailers out?",
            "🏆 Who won at the Oscars last night?",
            "🎵 What's the new hit song everyone is talking about?"
        ]
    },
    {
        id: 23,
        ...
        sampleQuestions: [
            ...
            "🔬 Summarize this scientific paper into three key points.",
            "📖 Give me the main plot points of this book chapter.",
            "📧 Can you summarize this long email thread?"
        ]
    },
    {
        id: 24,
        ...
        sampleQuestions: [
            ...
            "🍍 Argue for the case that pineapple belongs on pizza.",
            "🤖 Debate the pros and cons of artificial intelligence.",
            "📚 Let's argue about whether physical books are better than e-books."
        ]
    },
    {
        id: 25,
        ...
        sampleQuestions: [
            ...
            "✍️ Can you explain what 'power of attorney' means?",
            "🏢 What does 'LLC' stand for in business?",
            "⚖️ Explain the concept of 'due process'."
        ]
    },
    {
        id: 26,
        ...
        sampleQuestions: [
            ...
            "🎤 Help me write a rap verse about success.",
            "❤️ Write a haiku about love."
        ]
    },
    {
        id: 27,
        ...
        sampleQuestions: [
            ...
            "💻 Can you explain this block of JavaScript to me?",
            "❓ How does this SQL query work?",
            "⚙️ Explain recursion in simple terms."
        ]
    },
    {
        id: 28,
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "📺 I liked 'Stranger Things', what should I watch next?",
            "🤔 What is the plot of 'Inception'?",
            "🎬 Can you suggest a classic movie from the 1990s?"
        ]
    },
    {
        id: 30,
        ...
        sampleQuestions: [
            ...
            "🐛 How do I get rid of pests on my plants naturally?",
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "📊 Can you help me make a budget for a $3000 monthly income?",
            "📈 What's the 50/30/20 rule for budgeting?",
            "💸 Suggest ways to cut down on my monthly expenses."
        ]
    },
    {
        id: 32,
        ...
        sampleQuestions: [
            ...
            "⚛️ Can you explain what an atom is?",
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "🍜 Describe the main flavors of Thai cuisine.",
            "🧀 What's the difference between brie and camembert?",
            "🍝 What is a must-try dish in Italian cuisine?"
        ]
    },
    {
        id: 34,
        ...
        sampleQuestions: [
            ...
            "📜 Can you give me my horoscope for today?",
            "❤️ Which zodiac signs are most compatible?",
            "🌙 What does it mean if my moon sign is in Scorpio?"
        ]
    },
    {
        id: 35,
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "🏛️ Can you explain Stoicism in simple terms?",
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "🍽️ What are some good theme ideas for a dinner party?",
            "📋 Create a checklist for planning a small wedding.",
            "🍾 How much food should I prepare for 20 guests?"
        ]
    },
    {
        id: 39,
        ...
        sampleQuestions: [
            ...
            "👨‍💼 I need to give a motivational speech to my team.",
            "🎓 Help me write a graduation speech.",
            "📊 How do I start a presentation to make it engaging?"
        ]
    },
    {
        id: 40,
        ...
        sampleQuestions: [
            ...
            "♣️ Can you explain how to play Solitaire?",
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "✅ Can you fact-check this news headline for me?",
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "⚖️ Let's discuss a complex ethical dilemma.",
            "🧐 What is utilitarianism?",
            "🤔 Help me think through a moral problem at work."
        ]
    },
    {
        id: 44,
        ...
        sampleQuestions: [
            ...
            "🧠 Can you create an analogy for blockchain?",
            "📈 Explain stock market volatility with a simple comparison.",
            "🔗 What's a good analogy for how the internet works?"
        ]
    },
    {
        id: 45,
        ...
        sampleQuestions: [
            ...
            "🏖️ I need a short caption for a beach photo.",
            "🐶 Can you create a cute caption for a picture of my dog?",
            "❤️ Suggest a romantic caption for a photo with my partner."
        ]
    },
    {
        id: 46,
        ...
        sampleQuestions: [
            ...
            "🐦 Can you help me with a witty Twitter bio?",
            "💼 I need a professional bio for my LinkedIn profile.",
            "🎨 Suggest a bio for an artist's profile."
        ]
    },
    {
        id: 47,
    ...
    },
    {
        ...
        sampleQuestions: [
            ...
            "🚌 What's the best way to get to the airport via public transport?",
            "🗺️ Describe the route from the Eiffel Tower to the Louvre."
        ]
    },
    {
        id: 49,
        ...
        sampleQuestions: [
            ...
            "📧 Critique this email for tone and clarity.",
            "✍️ What are the weaknesses in this short story?"
        ]
    },
    {
        id: 50,
        ...
        sampleQuestions: [
            ...
            "😠 What's a healthy way to resolve a disagreement with a friend?",
            "💔 How do I deal with a breakup?",
            "🤔 Suggest a way to reconnect with a family member."
        ]
    },
    {
        id: 51,
        ...
        sampleQuestions: [
            ...
            "🍕 I can't decide between pizza or tacos for dinner.",
            "✈️ Help me decide where to go on vacation.",
            "🪙 Just flip a coin for me: heads or tails?"
        ]
    }
]